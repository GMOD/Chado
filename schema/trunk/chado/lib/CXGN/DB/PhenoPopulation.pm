...
#####################################################################
#
#  Program : $Id: PhenoPopulation.pm,v 1.1 2008-03-03 18:57:50 nm249 Exp $
#  Author  : $Author: nm249 $
#  Date    : $Date: 2008-03-03 18:57:50 $
#  Version : 2.0
#  CHECKOUT TAG: $Name: not supported by cvs2svn $
#
...
my $image_top_path = $vhost_conf->get_conf('data_shared_url').'/phenotype_images/';
my $gen_image_dir = $image_top_path . '/generated_images/';
my $prop_image_dir = $image_top_path . '/prop_images/';
my $system_prop_image_dir = $vhost_conf->get_conf('data_shared_website_path').'/phenotype_images/prop_images/';
my $original_image_dir = $image_top_path . '/plant_images/';
