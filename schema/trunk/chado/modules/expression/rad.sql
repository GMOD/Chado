ome of the pk/fk names to conform to chado conventions (removed _)
...
create table acquisition (
    acquisition_id           																				int not null serial,
...
create table acquisitionparam (
    acquisitionparam_id      																				int not null serial,
...
create table analysis (
    analysis_id              																				int not null serial,
...
create table analysisimplementation (
    analysisimplementation_id          																		int not null serial,
...
create table analysisimplementationparam (
    analysisimplementationparam_id     																		int not null serial,
...
create table analysisinput (
    analysisinput_id         																				int not null serial,
...
create table analysisinvocation (
    analysisinvocation_id              																		int not null serial,
...
create table analysisinvocationparam (
    analysisinvocationparam_id         																		int not null serial,
...
create table analysisoutput (
    analysisoutput_id       																				int not null serial,
...
create table assay_biomaterial (
    assay_biomaterial_id    																				int not null serial,
...
create table assay_labeledextract (
    assay_labeledextract_id 																				int not null serial,
...
create table biomaterial_cvterm (
    biomaterial_cvterm_id     																				int not null serial,
...
create table biomaterial (
    biomaterial_id                   																		int not null serial,
...
create table biomaterialmeasurement (
    biomaterialmeasurement_id        																		int not null serial,
...
create table channel (
    channel_id               																				int not null serial,
...
create table compositeelementresult (
    compositeelementresult_id          																		int not null serial,
	primary key (compositeelementresult_id),
    compositeelement_id                																		int not null,
	foreign key (compositelement_id) references feature (feature_id),
...
create table control (
    control_id               																				int not null serial,
...
create table element (
    element_id                         																		int not null serial,
...
create table elementresult (
    elementresult_id                   																		int not null serial,
...
create table labelmethod (
    labelmethod_id           																				int not null serial,
    ...
    labelmethod             																				varchar2(1000) null
);

--ok
drop table if exists magedocumentation;
create table magedocumentation (
    magedocumentation_id     																				int not null serial,
...
create table processimplementation (
    processimplementation_id           																		int not null serial,
...
create table processimplementationparam (
    processimplemetationparam_id       																		int not null serial,
...
create table processinvocation (
    processinvocation_id              																		int not null serial,
...
create table processinvocationparam (
    processinvocationparam_id          																		int not null serial,
...
create table processinvocation_quantification (
    processinvocation_quantification_id      																int not null serial,
...
create table processio (
    processio_id             																				int not null serial,
...
create table processresult (
    processresult_id         																				int not null serial,
...
create table projectlink (
    projectlink_id           																				int not null serial,
...
create table protocol (
    protocol_id                        																		int not null serial,
    ...
    protocoldescription               																		varchar2(4000) null,
    hardwaredescription               																		varchar2(500) null,
    softwaredescription               																		varchar2(500) null
);

--ok
drop table if exists protocolparam;
create table protocolparam (
    protocolparam_id         																				int not null serial,
    ...
    unittype_id             																				int null,
	foreign key (unitterm_id) references cvterm (cvterm_id),
    value                    																				varchar(100) null,
);
...
create table quantification (
    quantification_id        																				int not null serial,
...
create table quantificationparam (
    quantificationparam_id   																				int not null serial,
...
create table relatedacquisition (
    relatedacquisition_id              																		int not null serial,
...
create table relatedquantification (
    relatedquantification_id           																		int not null serial,
...
create table study_assay (
    study_assay_id           																				int not null serial,
...
create table studydesign (
    studydesign_id           																				int not null serial,
...
create table studydesign_assay (
    studydesign_assay_id    																				int not null serial,
...
create table studydesigndescription (
    studydesigndescription_id         																		int not null serial,
...
create table studyfactor (
    studyfactor_id          																				int not null serial,
...
create table studyfactorvalue (
    studyfactorvalue_id      																				int not null serial,
...
create table treatment (
    treatment_id             																				int not null serial,
