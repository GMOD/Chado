-- The Audit module is not a module in the same sense as 
-- the other Chado modules. It is a set of recommendations 
-- on how one might implement auditing in Chado. The SQL 
-- used at Flybase is shown here for purposes of illustration.
--
-- audit tables generated by:
