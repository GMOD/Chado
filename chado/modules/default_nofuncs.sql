--DO NOT edit this file directly; doing so may break any applications
--that depend on Class::DBI.  If you want a different complete.sql
--modify the appropriate module file and rebuild the database with
-- `perl Makefile.PL
