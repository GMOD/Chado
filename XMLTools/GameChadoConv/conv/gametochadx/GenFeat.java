...
private String m_timestamp;
	...
	public void setAuxResidues(String the_AuxResidues){
		m_AuxResidues = the_AuxResidues;
	}

	public String getAuxResidues(){
		return m_AuxResidues;
	}
	...
	public Vector getProducedSequenceList(){
		...
		for(int i=0;i<m_ComponentList.size();i++){
			...
			ps.addAll(gf.getProducedSequenceList());
		}
		return ps;
	}
