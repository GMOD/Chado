...
use Util::GeneralUtil::Properties;
...
sub usage()
 {
  print "\nusage:$0 [-d chado_gadfly5] [-p output] [-f format_type] [-t tables] [-o op_type] [-g dumpspec] [-s struct_type] [r loadable]",
    ...
    "\nexample1: $0  -d chado_gadfly5 -g \"/users/zhou/work/API/Config/dumpspec_gene.xml\" -p \"/export/zhou/dump_gene_no_local_id.xml\" -f no_local_id  ",
    "\nexample2: $0  -d chado_gadfly5 -g \"/users/zhou/work/API/Config/dumpspec_scaffold.xml\" -p \"/export/zhou/dump_scaffold_local_id.xml\" -f local_id -a \"1 14473012 14476172 AE002603\" ",
